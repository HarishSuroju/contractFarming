<?php
// Get the season from URL parameters
$season = $_GET['season'] ?? '';

// Define crops for each season
$crops = [];
if ($season === 'summer') {
    $crops = ["Rice", "Maize", "Millets", "Cotton", "Sugarcane", "Groundnut", "Pulses", "Soybean"];
...
<div class="container">
    ...
    <div class="products">
        <?php foreach ($crops as $crop): ?>
            <a href="Fprofiles.php?product=<?php echo strtolower($crop); ?>" class="product-item">
